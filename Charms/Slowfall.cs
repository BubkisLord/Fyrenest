...
namespace Fyrenest
{
    internal class Slowfall : Charm
    {
        ...
        private void ChangeGravity()
        {
            ...
            rb.gravityScale = (Equipped() && !InInventory() && HeroController.instance.transitionState == HeroTransitionState.WAITING_TO_TRANSITION && HeroController.instance.cState.falling) ? 0.3f : 0.79f;
        }
    }
}